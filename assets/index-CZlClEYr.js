...
`;var y=new Set,b=class extends HTMLElement{#e;#t;#n;#r=null;static observedAttributes=[`name`,`size`,`color`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#e.appendChild(v.content.cloneNode(!0)),this.#t=this.#e.getElementById(`icon-container`),this.#n=this.#e.querySelector(`slot`)}connectedCallback(){this.#r=new AbortController;let{signal:e}=this.#r;this.#n.addEventListener(`slotchange`,()=>this.#s(),{signal:e}),this.#a(this.getAttribute(`size`)),this.#o(this.getAttribute(`color`)),this.#i(this.getAttribute(`name`)),this.#s()}disconnectedCallback(){this.#r?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`name`:this.#i(n);break;case`size`:this.#a(n);break;case`color`:this.#o(n);break}}get name(){return this.getAttribute(`name`)}set name(e){e?this.setAttribute(`name`,e):this.removeAttribute(`name`)}get size(){return this.getAttribute(`size`)}set size(e){e?this.setAttribute(`size`,e):this.removeAttribute(`size`)}get color(){return this.getAttribute(`color`)}set color(e){e?this.setAttribute(`color`,e):this.removeAttribute(`color`)}static get catalog(){return Object.keys(g)}#i(e){if(this.#t.innerHTML=``,!e)return;let t=re[e];if(!t){y.has(e)||(console.warn(`[ui-icon] Ícone "${e}" não encontrado no catálogo. Use um <svg> via slot para ícones customizados.`),y.add(e));return}let n=document.createElementNS(`http://www.w3.org/2000/svg`,`svg`);n.setAttribute(`part`,`svg`),n.setAttribute(`viewBox`,`0 0 24 24`),n.setAttribute(`xmlns`,`http://www.w3.org/2000/svg`),n.setAttribute(`fill`,`none`),n.setAttribute(`stroke`,`currentColor`),n.setAttribute(`aria-hidden`,`true`),n.innerHTML=t,this.#t.appendChild(n)}#a(e){let t=te(e);this.style.setProperty(`--icon-size`,`${t}px`)}#o(e){let t=e||`currentColor`;this.style.setProperty(`--icon-color`,t)}#s(){let e=this.#n.assignedElements({flatten:!0}),t=e.length>0;this.#t.hidden=t,t&&e.forEach(e=>{e.setAttribute(`aria-hidden`,`true`),e.tagName?.toLowerCase()===`svg`&&!e.hasAttribute(`viewBox`)&&console.warn(`[ui-icon] SVG customizado sem atributo viewBox pode não escalar corretamente.`)}),this.dispatchEvent(new CustomEvent(`ui-icon:slotchange`,{detail:{hasSlotContent:t},bubbles:!0,composed:!0}))}};customElements.define(`ui-icon`,b);var x=class extends HTMLElement{_initialContent=``;static get observedAttributes(){return[`variant`,`disabled`]}connectedCallback(){this._initialContent||=this.innerHTML,this.render()}attributeChangedCallback(){this.render()}render(){!this._initialContent&&this.innerHTML&&(this._initialContent=this.innerHTML);let e=this.getAttribute(`variant`)||`primary`,t=this.hasAttribute(`disabled`);this.innerHTML=``;let n=document.createElement(`button`);n.className=`btn btn-${e} w-full`,t&&n.setAttribute(`disabled`,``),n.innerHTML=this._initialContent,this.appendChild(n)}};customElements.define(`app-button`,x);var S=class e extends HTMLElement{static idCounter=0;inputId;constructor(){super(),e.idCounter++,this.inputId=`app-input-${e.idCounter}`}static get observedAttributes(){return[`label`,`value`,`placeholder`,`type`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){let r=this.querySelector(`input`);r?(e===`value`&&(r.value=n),e===`placeholder`&&(r.placeholder=n),e===`type`&&(r.type=n)):this.render()}render(){let e=this.getAttribute(`label`)||``,t=this.getAttribute(`label-icon`)||``,n=this.getAttribute(`value`)||``,r=this.getAttribute(`placeholder`)||``,i=this.getAttribute(`type`)||`text`;this.innerHTML=`
...
`;var E={danger:`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
    ...
    `}};customElements.define(`image-uploader`,M);var N=class extends HTMLElement{static get observedAttributes(){return[`section-id`]}connectedCallback(){this.render()}updateData(e){let t=this.getAttribute(`section-id`);i.updateSectionData(t,e)}render(){let e=this.getAttribute(`section-id`),t=i.state.sections.find(t=>t.id===e);if(!t||t.type!==`images`)return;let n=t.data;this.innerHTML=`
      <div class="space-y-4">
...
`)}"><ui-icon name="alert-triangle" size="xs" class="shrink-0"></ui-icon> ${this.warnings.length}</span>`:``}
    ...
    `,this.querySelector(`#view-toggle-status`)?.addEventListener(`click`,e=>{e.stopPropagation(),i.togglePreview()})}};customElements.define(`app-status-bar`,R);var z=[`default`,`success`,`danger`,`warning`,`info`],B=[`sm`,`md`,`lg`,`xl`,`fullscreen`],V=[`fade`,`scale`,`slide`,`flip`],H={default:{accent:`#6366f1`,fg:`#fff`,icon:null},success:{accent:`#16a34a`,fg:`#fff`,icon:`✓`},danger:{accent:`#dc2626`,fg:`#fff`,icon:`!`},warning:{accent:`#d97706`,fg:`#fff`,icon:`⚠`},info:{accent:`#0284c7`,fg:`#fff`,icon:`i`}},U={sm:`28rem`,md:`40rem`,lg:`56rem`,xl:`72rem`,fullscreen:`100vw`};function W(e){return z.includes(e)}function G(e){return B.includes(e)}function K(e){return V.includes(e)}var q=`
  :host {
    display: contents;
...
`,J=`a[href],button:not([disabled]),input:not([disabled]),select:not([disabled]),textarea:not([disabled]),[tabindex]:not([tabindex="-1"]),details>summary`,Y=class extends HTMLElement{#e;#t;#n=null;#r;#i;#a;#o;#s;#c;#l;#u=!1;#d=!1;#f=null;static formAssociated=!0;static observedAttributes=[`variant`,`size`,`animation`,`heading`,`open`];constructor(){super(),this.#e=this.attachShadow({mode:`open`}),this.#t=this.attachInternals();let e=new CSSStyleSheet;e.replaceSync(q),this.#e.adoptedStyleSheets=[e],this.#e.innerHTML=ie,this.#m()}connectedCallback(){if(this.#d)return;this.#d=!0,this.#n=new AbortController;let e=this.#n.signal;this.#a.addEventListener(`click`,()=>this.close(),{signal:e}),this.#r.addEventListener(`click`,e=>{e.target===this.#r&&this.#b()},{signal:e}),this.#l.addEventListener(`slotchange`,()=>{let e=this.#l.assignedNodes({flatten:!0}).length>0;this.#c.classList.toggle(`hidden`,!e)},{signal:e}),this.#r.addEventListener(`keydown`,e=>{if(e.key===`Escape`){e.preventDefault(),this.#b();return}e.key===`Tab`&&this.#C(e)},{signal:e}),this.#h()}disconnectedCallback(){this.#d=!1,this.#n?.abort()}attributeChangedCallback(e,t,n){if(t!==n)switch(e){case`variant`:this.#g(n);break;case`size`:this.#_(n);break;case`animation`:break;case`heading`:this.#o.textContent=n??``;break;case`open`:{let e=n!==null;e&&!this.#p&&!this.#u&&this.#v(),!e&&this.#p&&!this.#u&&this.#y();break}}}open(){this.#p||this.#u||this.setAttribute(`open`,``)}close(){!this.#p||this.#u||this.removeAttribute(`open`)}toggle(){this.#p?this.close():this.open()}get isOpen(){return this.#p}get variant(){let e=this.getAttribute(`variant`);return W(e)?e:`default`}set variant(e){this.setAttribute(`variant`,W(e)?e:`default`)}get size(){let e=this.getAttribute(`size`);return G(e)?e:`md`}set size(e){this.setAttribute(`size`,G(e)?e:`md`)}get animation(){let e=this.getAttribute(`animation`);return K(e)?e:`scale`}set animation(e){this.setAttribute(`animation`,K(e)?e:`scale`)}get heading(){return this.getAttribute(`heading`)??``}set heading(e){this.setAttribute(`heading`,e)}addEventListener(e,t,n){super.addEventListener(e,t,n)}removeEventListener(e,t,n){super.removeEventListener(e,t,n)}get#p(){return this.#r.classList.contains(`is-open`)}#m(){let e=e=>this.#e.querySelector(e);this.#r=e(`.overlay`),this.#i=e(`.panel`),this.#a=e(`.close-btn`),this.#o=e(`#modal-title`),this.#s=e(`.icon-badge`),this.#c=e(`.footer`),this.#l=e(`slot[name="footer"]`)}#h(){this.hasAttribute(`variant`)&&this.#g(this.getAttribute(`variant`)),this.hasAttribute(`size`)&&this.#_(this.getAttribute(`size`)),this.hasAttribute(`heading`)&&(this.#o.textContent=this.getAttribute(`heading`)),this.hasAttribute(`open`)&&this.#v()}#g(e){let t=H[W(e)?e:`default`],n=this.#e.host;n.style.setProperty(`--_accent`,t.accent),n.style.setProperty(`--_fg`,t.fg),this.#s.textContent=t.icon??``}#_(e){let t=G(e)?e:`md`;this.#i.style.setProperty(`--_width`,U[t])}#v(){this.#u=!0,this.#f=document.activeElement,this.#r.classList.add(`is-open`),this.#r.removeAttribute(`aria-hidden`),this.#t.states?.add(`open`),requestAnimationFrame(()=>{(this.#T()??this.#a).focus(),this.#u=!1}),this.#S(`ui-modal:open`)}#y(e=!1){this.#u=!0,this.#r.classList.replace(`is-open`,`is-closing`);let t=this.#x(getComputedStyle(this.#e.host).getPropertyValue(`--modal-duration`));setTimeout(()=>{this.#r.classList.remove(`is-closing`),this.#r.setAttribute(`aria-hidden`,`true`),this.#t.states?.delete(`open`),this.#u=!1,this.#f?.focus?.(),this.#f=null,e&&this.#S(`ui-modal:cancel`),this.#S(`ui-modal:close`)},t)}#b(){!this.#p||this.#u||(this.#u=!0,this.removeAttribute(`open`),this.#y(!0))}#x(e){let t=e.trim().match(/^(\d+(?:\.\d+)?)(ms|s)?$/);if(!t||t[1]===void 0)return 280;let n=parseFloat(t[1]);return(t[2]??`ms`)===`s`?n*1e3:n}#S(e){let t={modal:this};this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,detail:t}))}#C(e){let t=this.#w();if(!t.length){e.preventDefault(),this.#a.focus();return}let n=t[0],r=t[t.length-1],i=this.#e.activeElement??document.activeElement;if(!i||!t.includes(i)){e.preventDefault(),n.focus();return}e.shiftKey&&i===n?(e.preventDefault(),r.focus()):!e.shiftKey&&i===r&&(e.preventDefault(),n.focus())}#w(){return[...Array.from(this.#e.querySelectorAll(J)),...Array.from(this.querySelectorAll(J))]}#T(){return this.#w().find(e=>e!==this.#a)??null}};customElements.define(`ui-modal`,Y);var ae=class extends HTMLElement{isInitialized=!1;draftTemplate=null;connectedCallback(){this.isInitialized||=(this.renderSkeleton(),!0),this.renderSections(),this.setupGlobalListeners()}setupGlobalListeners(){e.on(r.SECTION_ADDED,()=>this.renderSections()),e.on(r.SECTION_REMOVED,()=>this.renderSections()),e.on(r.SECTIONS_REORDERED,()=>this.renderSections()),e.on(r.STATE_LOADED,()=>this.renderSections()),e.on(r.REPORT_UPDATED,e=>{this.syncInputs(e)}),e.on(r.LAYOUT_WARNING,e=>{let t=this.querySelector(`#layout-alert`);t&&(e.hasOverflow?(t.classList.remove(`hidden`),t.classList.add(`flex`)):(t.classList.add(`hidden`),t.classList.remove(`flex`)))})}renderSkeleton(){let{config:e}=i.state;this.className=`panel-editor`,this.innerHTML=`
      ...
      <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-3">
          <img src="${A}" alt="Aura Technical" class="w-8 h-8 object-contain" onerror="this.style.display='none'" />
