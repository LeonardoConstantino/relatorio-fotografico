...
| **16** | [Suporte a Markdown nas Seções de Texto](./tasks/16_markdown_support.md) | [x] | 03, 06 |
| **17** | [Edição Avançada de Imagem (Crop, Rotate, Meta)](./tasks/17_advanced_image_editor.md) | [x] | 07 |
